...
class ReportevolumenNegociado(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, datas):
        ...
        while x <= 12:
            ...
            _logger.info(f"Tipo de cambio para {self.get_last_date_of_month(year, x)}: {currency_rate}")  # Agregar log para depuración
            rightAndWrite(currency_rate, numerico)  # Escribir el tipo de cambio en la hoja
            x = x + 1
