...
class PosInvoiceReportPy(models.AbstractModel):
    _name = 'report.point_of_sale.report_invoice_py'

    """
        Del pos.order se busca los datos de las facturas que seran entregados al 
        qweb de la factura 
    """
