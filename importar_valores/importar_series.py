...
from_date = '2024-02-15 00:00:00'
to_date = '2025-03-27 00:00:00'
#from_date_str = '2024-01-01 00:00:00'
#to_date_str = '2025-01-26 00:00:00'
LOTE_ENVIO = 200
...
def obtener_series_desde_BD():
    ...
    print("Se hizo la select del maria")
    print(columns)
