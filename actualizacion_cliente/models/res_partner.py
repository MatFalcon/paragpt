...
class ResPartner(models.Model):
    ...
    ultima_actualizacion = fields.Date(string="Ultima actualizacion de datos",tracking=True)
    registro_actualizacion = fields.Boolean(string="Registro de actualizacion", default=False,tracking=True)
