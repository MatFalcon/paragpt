...
class AccountMove(models.Model):
    ...
    asset_fa_id = fields.Many2one('account.asset', string="Ingreso Diferido")
    ...
    def _prepare_move_for_asset_depreciation(self, vals):
        ...
        move_line_2 = {
            'name': asset.name,
            'partner_id': partner.id,
            'account_id': asset.account_depreciation_expense_id.id if not asset.flujo_alternativo else asset.account_depreciation_expense_cp_id.id,
