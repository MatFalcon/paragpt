...
class accountPaymentRegister(models.TransientModel):
    ...
    def _create_payment_vals_from_wizard(self,batch_result):
        ...
        if factura:
            ...
            _logger.info("Asignando fecha_factura: %s y numero_factura: %s al payment_vals", fecha_factura,
                         numero_factura)
        else:
            payment_vals.update({
                'fecha_factura': None,
            ...
            _logger.info(
                "No se encontró factura asociada, payment_vals fecha_factura y numero_factura se asignan como None")
