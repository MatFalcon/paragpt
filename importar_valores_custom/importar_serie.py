...
def get_miembros_compensadores():
    print("Entra en get_miembros_compensadores")
    # conn = pyodbc.connect(
...
def get_registros():
    ...
    to_date = '2025-03-28'
    print("Se hace select en el rango", from_date, " a", to_date)
    cursor.execute(
        'SELECT * '
        'FROM operaciones '
...
def create_novedad(row, id_casa_bolsa, miembros_compensadores):
    ...
    # print("Miembro compensador", miembro_compensador)
    if miembro_compensador:
        print("Se busca Persona")
